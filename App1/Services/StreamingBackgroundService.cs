...
namespace App1.Services
{
    ...
    public class StreamingBackgroundService : Service, AudioManager.IOnAudioFocusChangeListener
    {
        ...
        public string Mp3 = @"https://telugustories.blob.core.windows.net/audio/AUD-20151213-WA0001.mp3";
        ...
        public override void OnCreate()
        {
            ...
            pref = new AppPreferences(ApplicationContext);
        }
        ...
        {
            if (!string.IsNullOrEmpty(intent.GetStringExtra("SourceId")))
            {
                Mp3 = intent.GetStringExtra("SourceId");
                sourceChanged = true;
            }
        ...
        private void StartForeground()
        {
            ...
            notification.SetLatestEventInfo(ApplicationContext, "Malli Gaadi Kathalu Streaming", "Playing music!", pendingIntent);
